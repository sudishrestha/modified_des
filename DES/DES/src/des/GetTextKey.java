...
public class GetTextKey {
    ...
    public GetTextKey(String a, String b) {
        String part1 = a.substring(0, 32);
        String part2 = a.substring(32);
        ...
        String z = new valueXor().xore(apf, part1);
        String encrypted = part2 + z;

        app = new convertHex().converts(encrypted);
    }
